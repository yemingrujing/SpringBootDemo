...
public class SecssUtil {
    ...
    public static SecssUtil create() {
    ...
    public static Map<String, String> post(Map<String, String> reqData, String reqUrl, String encoding) {
        ...
        try {
            ...
            if (200 == status) {
                String resultString = URLDecoder.decode(hc.getResult(), "UTF-8");
     ...
     * @return 应答http 200返回true ,其他false<br>
     */
    public static Map<String, String> refundPost(Map<String, String> reqData, String reqUrl, String encoding) {
        Map<String, String> rspData = new HashMap<>();
        log.info("请求ChinaPay地址:" + reqUrl);
        //发送后台请求数据
        //连接超时时间，读超时时间（可自行判断，修改）
    ...
    public static Map<String, String> getAllRequestParam(final HttpServletRequest request) {
        ...
        if (null != temp) {
            while (temp.hasMoreElements()) {
                ...
                String value = URLDecoder.decode(request.getParameter(en));
                res.put(en, value);
