...
public class SecssConstants {
     ...
     * 商户号
     */
    public static String MERID = "acpsdk.merId";
    /**
     * 版本号
     */
    public static String VERSION = "acpsdk.version";
    /**
     * 配置文件中的前台URL常量
     */
    public static String SDK_FRONT_URL = "acpsdk.frontTransUrl";
    /**
     * 配置文件中的后台URL常量
     */
    public static String SDK_BACK_URL = "acpsdk.backTransUrl";
    /**
     * 配置文件中的后续类交易退款URL常量
     */
    public static String SDK_REFUND_URL = "acpsdk.refundTransUrl";
    /**
     * 签约后台通知地址
     */
    public static String SIGNCALLBACK = "acpsdk.signBackUrl";
    /**
     * 支付后台通知地址
     */
    public static String PAYCALLBACK = "acpsdk.payBackUrl";

    /**
     * 退款后台通知地址
     */
    public static String REFUNDBACKURL = "acpsdk.refundBackUrl";

    public static HashMap ERRMAP = new HashMap();
