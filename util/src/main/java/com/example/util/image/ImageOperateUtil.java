...
public class ImageOperateUtil {
    ...
    public static BufferedImage makeRoundImg(Image image,
        ...
        if (image.getWidth(null) > image.getHeight(null)) {
            ...
            y = 0;
            x = (image.getWidth(null) - image.getHeight(null)) >> 1;
        } else {
     ...
     * @return
     */
    public static BufferedImage makeRoundBorder(Image image,
                                                int cornerRadius,
                                                Color color) {
        int size = image.getWidth(null) / 15;
        int w = image.getWidth(null) + size;
        int h = image.getHeight(null) + size;
